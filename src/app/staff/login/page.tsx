      ...
      <div className="w-full max-w-md space-y-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="staff@polytechnic.edu.ng"
                  {...register("email")}
                />
                {errors.email && (
        ...
        <div className="text-center space-y-2">
          <div className="flex items-center justify-center gap-4 text-sm">
            ...
            <Link href="/examiner/login" className="text-green-600 hover:underline">
              Examiner Portal
            </Link>
            <Link href="/candidate/login" className="text-green-600 hover:underline">
              Candidate Portal
            </Link>
          </div>
