      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter your super administrator credentials to access system-wide controls
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-6 text-center">
          <div className="flex items-center justify-center space-x-4 text-sm text-gray-600">
            <a href="/login/admin" className="hover:text-red-600 transition-colors">
              Admin Login
            </a>
            <span>•</span>
            <a href="/login/staff" className="hover:text-red-600 transition-colors">
              Staff Login
            </a>
            <span>•</span>
            <a href="/login/candidate" className="hover:text-red-600 transition-colors">
              Candidate Login
            </a>
          </div>
        </div>
