...
export default function CandidateLoginPage() {
  ...
  const { loginCandidate, isLoading } = useAuth()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await loginCandidate(formData.email, formData.password)
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter your candidate credentials to access your application dashboard
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-6 text-center">
          <div className="flex items-center justify-center space-x-4 text-sm text-gray-600">
            <a href="/login/super-admin" className="hover:text-purple-600 transition-colors">
              Super Admin
            </a>
            <span>•</span>
            <a href="/login/admin" className="hover:text-purple-600 transition-colors">
              Admin Login
            </a>
            <span>•</span>
            <a href="/login/staff" className="hover:text-purple-600 transition-colors">
              Staff Login
            </a>
          </div>
        </div>
